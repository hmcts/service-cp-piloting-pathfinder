...
| `oauth-mock` | Testing/Development | HS256 | `Authorization: Bearer` | Shared secret |
...
- **Development**: Use `jwt` or `oauth-mock` with shared secrets
