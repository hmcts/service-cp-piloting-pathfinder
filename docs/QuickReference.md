...
| `oauth-mock` | `AUTH_PROVIDER=oauth-mock` | `JWT_SECRET_KEY` |
...
| `oauth-mock` | `Authorization: Bearer <token>` | `Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9...` |
...
AUTH_PROVIDER=oauth-mock ./gradlew bootRun
...
```bash
# Provider selection
AUTH_PROVIDER=jwt|oauth-mock|oauth-RS256
